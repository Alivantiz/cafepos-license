...
средний чек, график по дням, данные лицензии, заметка, **Продлить** (от
сегодня или текущего срока — что позже, `revoked` снимается) с готовым
текстом клиенту, **Отозвать/Вернуть**.
